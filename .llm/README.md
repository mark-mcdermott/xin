# Xun LLM Context Documentation

This directory contains tool-agnostic documentation and guidelines for AI coding assistants (Claude Code, GitHub Copilot, Cursor, Codex CLI, etc.) working on Xun, a lightweight desktop note-taking application for macOS.
...
- `xun-overview.md` - Project vision, features, and architecture
