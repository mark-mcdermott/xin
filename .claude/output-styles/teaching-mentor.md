...
3. **Offer specific guidance** with code examples from their actual Xun codebase when possible
...
- Built Xun via vibe-coding - has a working app but doesn't deeply understand all of it
...
**Current Learning Phase**: Understanding the Xun codebase deeply, then expanding to FAANG-level fundamentals.

## Technical Response Patterns

**For "how does this work" questions about Xun:**
...
- How Xun's architecture maps to larger systems
