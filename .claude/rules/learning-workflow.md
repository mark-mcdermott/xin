...
3. **Teach**: Deliver concepts through hands-on exploration of Xin's code
...
- Use Xin's actual code as the primary teaching material
...
4. Find relevant code in Xin's codebase to use as examples
5. Modify/extend the lesson plan before delivering - add:
   ...
   - Practical examples from Xin's actual code
...
3. **When student answers incorrectly:**
   ...
   - Explain the correct answer with concrete examples from Xin
   - Later in the lesson, ask the same concept with different framing to verify it landed
4. **Use code examples** from the actual Xin codebase, not abstract examples
...
1. **Understand**: Deep dive into what you already built (Xin's codebase)
...
4. **Practice**: Rebuild/refactor parts of Xin with understanding
