...
The Xin Electron + Vite + React + TypeScript project structure is now complete and tested!
...
│   ├── unit/              # Unit tests
│   └── e2e/               # E2E tests
├── .llm/llm/              # AI assistant context (fully updated)
...
5. **LLM Context**: The `.llm/llm/` directory contains comprehensive guidelines for AI assistants. Always refer to:
   - `.llm/llm/context/xin-overview.md` for project vision
   - `.llm/llm/rules/javascript.md` for coding standards
   - `.llm/llm/rules/architecture.md` for design patterns
