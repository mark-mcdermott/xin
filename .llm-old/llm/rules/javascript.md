...
See @.llm/llm/context/project-structure.md for directory structure.
...
See @.llm/llm/context/testing-strategy.md for test organization.
See @.llm/llm/rules/testing.md for testing quality standards.
