...
**Xun**: Desktop note-taking app with blog publishing. Electron 39 + React 19 + TypeScript 5 + Vite 7 + Tailwind CSS 4 + CodeMirror 6 + Zustand.
...
## Student Profile
~15yr QA, ~5yr frontend, MS in Software Engineering. Built Xun via vibe-coding, learning to deeply understand every piece. Goal: FAANG-level engineering.
