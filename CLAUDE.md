...
**App**: Desktop note-taking/journaling with blog publishing (Xin)
...
**Goal**: FAANG-level engineering competence, rebuild Xin from scratch understanding
**Approach**: Vibe-coded Xin quickly, now wants to deeply understand every piece
