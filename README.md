...
- Unlike Obsidian, Xun for note-taking is very simple and only does a few things (but tries to do them well):
  - `#tags`: tags in Xun start with a `#` and categorize your notes by topic
  - `[[internal links]]`: internal links in Xun have the `[[<note name>]]` format. A clicked internal link will take you to that note or create it if it doesn't exist.
...
### Blog CMS
- Xun makes it easy to quickly draft or write full blog posts throughout your day, without logging into a separate system or even navigate away from what you're doing.
- You can even write a blog post inside your daily note, without messing up the rest of your notes for that day.
- Xun has two ways to start a blog post in your daily note or anywhere else:
