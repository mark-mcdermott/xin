...
- **Focus**: Deep dive into Xun's Electron + React architecture
...
2. **Lesson 01-02**: Xun's Main Process Deep Dive (walk through src/main/index.ts)
...
**Mission**: Deeply understand every piece of Xun, fill engineering knowledge gaps, reach FAANG-level competence
**Student**: ~15yr QA, ~5yr frontend, MS in SE, vibe-coded Xun, wants to internalize everything
...
## Agent Context
**Ready for Phase 1: Understanding the Xun codebase.**
